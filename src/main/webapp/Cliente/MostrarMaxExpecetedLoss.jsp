...
<div style="margin: 50px 300px 50px 300px">
    <div style="color: #98999A; font-weight: bold">
        BANCO DEL PERU le recuerda:
        El riesgo en términos financieros, es la probabilidad que se produzca un acontecimiento que pueda
        ocasionar una perdida económica para una entidad. Uno de estos tipos es el riesgo de crédito, el cual es
        la perdida derivada de que la contraparte no cumpla con sus obligaciones de pago.
    </div>
    <div style="height: 40px; display: block;"></div>
    <div class="row">
        <div class="col-sm-5 col-md-5>" align="right" style="color: #309AFD; font-weight: bold">
